...
//         }
    ...
    public Connection getConnection(){
    	try {
        	...
        	sDBDriver = bundle.getString("spring.datasource.driverClass");
        	sConnStr = bundle.getString("spring.datasource.jdbcUrl");
            user = bundle.getString("spring.datasource.user");
