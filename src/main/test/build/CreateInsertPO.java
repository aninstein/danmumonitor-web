...
public class CreateInsertPO {
	...
	public static void main(String[] args) throws  Exception {
		...
		//生成CheckPOisNull类的函数
		File file=new File("F:\\Git\\myGithublibrary\\danmumonitor\\src\\main\\test\\out\\createInsert.txt");
		...
		for(String tableName:tableList){
			writeTxt.writeAppend(file, "/*"+tableName+"POInsert*/");//函数头注释
			writeTxt.writeCreateInsertPO(file, tableName);
		}
